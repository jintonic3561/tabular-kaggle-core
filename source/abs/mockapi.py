...
class MockApi:
    def __init__(self, dry_run=False):
        ...
        self.input_paths: Sequence[str] = "not_implemented"
        self.group_id_column: str = "not_implemented"
        self.export_group_id_column: bool = True # Not implemented
...
def make_env(dry_run=False):
    return MockApi(dry_run=dry_run)
